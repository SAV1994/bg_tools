...
class $GamesTable extends Games with TableInfo<$GamesTable, Game> {
  ...
  static const VerificationMeta _isExpansionMeta = const VerificationMeta(
    'isExpansion',
  );
  @override
  late final GeneratedColumn<bool> isExpansion = GeneratedColumn<bool>(
    'is_expansion',
    aliasedName,
    false,
  ...
  VerificationContext validateIntegrity(
    ...
    if (data.containsKey('is_expansion')) {
      context.handle(
        _isExpansionMeta,
        isExpansion.isAcceptableOrUnknown(
          data['is_expansion']!,
          _isExpansionMeta,
        ),
      );
  ...
  Game map(Map<String, dynamic> data, {String? tablePrefix}) {
    ...
    return Game(
      ...
      isExpansion: attachedDatabase.typeMapping.read(
        DriftSqlType.bool,
        data['${effectivePrefix}is_expansion'],
      )!,
...
class Game extends DataClass implements Insertable<Game> {
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    ...
    map['is_expansion'] = Variable<bool>(isExpansion);
  ...
  factory Game.fromJson(
    ...
    return Game(
      ...
      isExpansion: serializer.fromJson<bool>(json['isExpansion']),
  ...
  Map<String, dynamic> toJson({ValueSerializer? serializer}) {
    ...
    return <String, dynamic>{
      ...
      'isExpansion': serializer.toJson<bool>(isExpansion),
  ...
  Game copyWithCompanion(GamesCompanion data) {
    return Game(
      ...
      maxPlayers: data.maxPlayers.present
          ...
          : this.maxPlayers,
      isExpansion: data.isExpansion.present
          ? data.isExpansion.value
          : this.isExpansion,
  ...
  bool operator ==(Object other) =>
      ...
      (other is Game &&
          ...
          other.isExpansion == this.isExpansion &&
...
class GamesCompanion extends UpdateCompanion<Game> {
  ...
  const GamesCompanion({
    ...
    this.isExpansion = const Value.absent(),
  ...
  static Insertable<Game> custom({
    ...
    return RawValuesInsertable({
      ...
      if (isExpansion != null) 'is_expansion': isExpansion,
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    ...
    if (isExpansion.present) {
      map['is_expansion'] = Variable<bool>(isExpansion.value);
    }
    if (parentId.present) {
...
class $GamingSessionsTable extends GamingSessions
  ...
  @override
  List<GeneratedColumn> get $columns => [id, gameId, startedAt, finishedAt];
  @override
  String get aliasedName => _alias ?? actualTableName;
  @override
  String get actualTableName => $name;
...
class GamingSession extends DataClass implements Insertable<GamingSession> {
  ...
  @override
  int get hashCode => Object.hash(id, gameId, startedAt, finishedAt);
  @override
  bool operator ==(Object other) =>
      identical(this, other) ||
...
class GamingSessionsGamer extends DataClass
  ...
  @override
  int get hashCode => Object.hash(gamingSessionId, gamerId, score, place);
  @override
  bool operator ==(Object other) =>
      identical(this, other) ||
...
class $$GamesTableFilterComposer extends Composer<_$AppDatabase, $GamesTable> {
  ...
  ColumnFilters<bool> get isExpansion => $composableBuilder(
    column: $table.isExpansion,
    builder: (column) => ColumnFilters(column),
  );
...
class $$GamesTableOrderingComposer
  ...
  ColumnOrderings<bool> get isExpansion => $composableBuilder(
    column: $table.isExpansion,
    builder: (column) => ColumnOrderings(column),
  );
...
class $$GamesTableAnnotationComposer
  ...
  GeneratedColumn<bool> get isExpansion => $composableBuilder(
    column: $table.isExpansion,
    builder: (column) => column,
  );
        ...
        TableManagerState(
          ...
          updateCompanionCallback:
              ({
                ...
                Value<int?> minPlayers = const Value.absent(),
                Value<int?> maxPlayers = const Value.absent(),
                Value<bool> isExpansion = const Value.absent(),
                Value<int?> parentId = const Value.absent(),
