...
class GamersFormScreen extends ConsumerStatefulWidget {
  ...
  const GamersFormScreen({super.key, this.gamerId});

  @override
  ConsumerState<GamersFormScreen> createState() => _GamersFormScreenState();
}

class _GamersFormScreenState extends ConsumerState<GamersFormScreen> {
  ...
  Future<void> _loadData() async {
    if (widget.gamerId == null) {
      ...
      gamer = await gamerDao.get(widget.gamerId!);
    }
